...
object Bar {
    ...
    class Cart(val image: Int, val component: String, val price: String) {
        ...
        companion object {
            ...
            fun add() {
                if (list.size < 3) {
                    list.add(0, Cart(R.drawable.ic_menu_inactive, "GeForce GTX Titan 1080 GTX", "$489.99"))
                    list.add(1, Cart(R.drawable.ic_menu_inactive, "GeForce GTX Titan 1080 GTX", "$489.99"))
                    list.add(2, Cart(R.drawable.ic_menu_inactive, "GeForce GTX Titan 1080 GTX", "$489.99"))
                }
            }
        ...
        companion object {
            ...
            fun add() {
                if (list.size < 2) {
                    ...
                    list.add(7, Component(11, R.mipmap.ic_case))
                    list.add(8, Component(8, R.mipmap.ic_storage))
                    list.add(9, Component(9, R.mipmap.ic_powersupply))
                    list.add(10, Component(10, R.mipmap.ic_extstorage))
                    list.add(11, Component(7, R.mipmap.ic_opsystem))
                }
            }
        }
    }
